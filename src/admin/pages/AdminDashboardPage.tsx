...
const actionCards: ActionCard[] = [
  ...
  },
  {
    ...
    description: 'Add, edit and manage department pages, media and content.',
    path: '/admin-panel5463/departments',
    icon: GraduationCap,
  },
  {
    id: 'news-announcements',
    title: 'Manage News & Announcements',
    description: 'Publish homepage announcements and official notices.',
    path: '/admin-panel5463/news',
    icon: Newspaper,
  },
  {
    id: 'campus-news',
  ...
  },
  {
    ...
    description: 'Edit the Career Services Office page content, hero media and contact information.',
    path: '/admin-panel5463/career-services',
    icon: BriefcaseBusiness,
  },
  {
    id: 'events',
    title: 'Manage Events',
    description: 'Schedule campus events, dates and timings.',
    path: '/admin-panel5463/events',
    icon: Calendar,
  },
  {
    id: 'faculty',
    title: 'Manage Faculty',
    description: 'Add and update faculty member profiles.',
    path: '/admin-panel5463/faculty',
    icon: Users,
  },
  {
    id: 'societies',
    title: 'Manage Societies',
    description: 'Update student society pages and mentors.',
    path: '/admin-panel5463/societies',
    icon: Users,
  },
  {
    id: 'gallery',
    title: 'Manage Gallery',
    description: 'Upload campus event and activity photos.',
    path: '/admin-panel5463/gallery',
    icon: Image,
  },
  {
    id: 'header-footer',
