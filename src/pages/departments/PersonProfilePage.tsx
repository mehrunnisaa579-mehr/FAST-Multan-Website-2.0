    ...
    const fetchProfile = async () => {
      ...
      if (cmsStaff && cmsStaff.length > 0) {
        ...
        if (foundStaff) {
          ...
          setPerson({
            ...
            departmentOrOffice: officeObj ? officeObj.label : foundStaff.office || 'Administration Office',
      ...
      if (staticStaff) {
        ...
        setPerson({
          ...
          departmentOrOffice: officeObj ? officeObj.label : staticStaff.office || 'Administration Office',
