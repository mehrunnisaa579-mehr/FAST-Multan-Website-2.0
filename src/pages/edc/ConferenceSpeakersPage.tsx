      ...
      <div className="edc-content-wrapper text-left space-y-[45px]">
        {speakers.map((speaker, sIdx) => {
          ...
          return (
            ...
            >
              {/* Speaker Photo */}
              <div className={`w-full sm:w-[190px] h-[220px] rounded-[4px] flex items-center justify-center flex-shrink-0 overflow-hidden${photoSrc ? '' : ' bg-white border border-[#CCCCCC] p-[4px]'}`}>
                <CmsImage
                  src={photoSrc}
                  alt={speaker.name}
