...
export default function MissionPage() {
  ...
  return (
    <div className="w-full bg-white">
      ...
      <div className="w-full max-w-[900px] mx-auto px-[20px] min-[700px]:px-[24px] py-[40px] min-[700px]:py-[50px] min-[1100px]:pt-[65px] min-[1100px]:pb-[85px] flex flex-col items-center">
        <div className="w-full text-[#444444] text-[16px] leading-[1.8] font-normal text-justify space-y-[24px]">
          {missionText ? (
